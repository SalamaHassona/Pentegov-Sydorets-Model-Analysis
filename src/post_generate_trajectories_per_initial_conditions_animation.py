...
try:
    ...
    with open('time_series_xyz_x_0_5_y_4_z_1_R_17_62_C_3_14_L_1_t_400001_1000_ic.pickle', 'rb') as time_series_xyz:
    ...
    # plt.show()
    ani.save(filename="animation_200001_30_ic.mp4", writer="ffmpeg")
    pass

except Exception as ex:
    print("exception blabla: " + str(ex))
end = time.time()
print(str(end - start))
